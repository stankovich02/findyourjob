    ...
    <div class="content-wrapper" style="min-height: 1302.12px;">
        <section class="content w-50 mx-auto pt-5">
            <div class="card card-primary ">
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('admin.navs.update', $nav->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="navName">Name</label>
                            <input type="text" name="navName" class="form-control" id="navName" value="{{$nav->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="navRoute" class="form-control" id="navRoute" value="{{$nav->route}}">
